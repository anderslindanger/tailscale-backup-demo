# In-Laws Backup Server Setup

## Goal

Set up a backup server for the in-laws that:

1. Accepts Mac Time Machine backups over SMB
2. Stores backups locally
3. Replicates backups to an off-site server (adminserver) using rsync over Tailscale
4. Enforces secure access using Tailscale ACLs

---

## Prerequisites

- Ubuntu server installed(hostname set to inlaws)
- Tailscale account ready
- Adminserver already configured
...
•	rsync uses --delete to maintain mirror state 
•	Time Machine backups are stored in /backup/timemachine 

---

# 🎯 What you do now

1. Follow this EXACTLY on the in-laws server  
2. Don’t skip anything  
3. Treat it like a real deployment  
...
- Your system is **repeatable**
- Your docs are **valid**
- Your design is **real-world ready**
...
Then I’ll help you:
👉 refine docs  
👉 build final demo script  
👉 polish GitHub for submission
